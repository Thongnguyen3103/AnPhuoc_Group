...
OUT_XLSX     = r"\\hovmfs01\PKD\PhanPhoi\Thong.Nguyen\Report_BestSeller\04.Data_Xly\Data_BestSeller_LuyKe.xlsx".replace("Phooi","PhanPhoi")
...
def main():
    print("=" * 60)
    print("BẮT ĐẦU XỬ LÝ DỮ LIỆU BÁN")
    print("=" * 60)
    ...
    if mask_remaining.any():
        ...
        remaining_data = remaining_data.sort_values(["Report_item_name", "SoLuong"], ascending=[True, False])
